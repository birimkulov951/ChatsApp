...
import com.example.chatsapp.fragments.SearchFragment
import com.example.chatsapp.fragments.SettingsFragment
        ...
        refUsers!!.addValueEventListener(object : ValueEventListener{
            ...
            override fun onDataChange(p0: DataSnapshot) {
                if (p0.exists()) {
                    ...
                    Picasso.get().load(user.getProfile()).placeholder(R.drawable.blank_profile).into(profile_image)
                }
            }
